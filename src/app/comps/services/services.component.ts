...
export class ServicesComponent implements OnInit {
  ...
  data = [
    ...
    {
      title: "Web Apps",
      desc: "These are web application, often complex and they are typically the products which will then be supplied to end users."
    },
    {
      title: "3D / 2D Websites",
      desc: "These are simple but highly attractive Landing pages for businesses. 3D websites have cool interactions and animations"
    },
    {
      title: "Fix Your Apps",
